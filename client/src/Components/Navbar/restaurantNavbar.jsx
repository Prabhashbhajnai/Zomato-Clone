            ...
            <div className="flex items-center gap-3">
                ...
                </button>
                {
                    reduxState?.user?.fullname ? (
                        <>
                            <div onClick={() => setIsDropDownOpen(prev => !prev)} className="border p-2 border-gray-500 text-zomato-300 w-12 h-12 rounded-full">
                                <img
                        ...
                        <>
                            <span onClick={() => setIsDropDownOpen(prev => !prev)} className="border p-2 border-gray-500 text-zomato-300 rounded-full">
                                <FaUserAlt />
                            </span>
                            {isDropDownOpen && (
