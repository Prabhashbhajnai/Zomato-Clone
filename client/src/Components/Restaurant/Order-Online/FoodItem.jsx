    ...
    return (
        <>{food?.name && (
            <div className="flex items-start gap-2">
                {food?.image && (
                    <div className="w-3/12 h-24 md:h-28 md:px-2">
                        <img
                            src={food?.image}
                            alt="food"
                ...
                <div className="w-3/4 md:w-7/12 flex flex-col gap-1">
                    <div class="flex items-center justify-between ">                            
                        ...
                        <button 
                            ...
                            className="md:hidden flex items-center gap-2 text-zomato-400 bg-zomato-50 border-zomato-400 px-2 py-1 rounded-lg"
                        >
                            {food.isAddedToCart ? (
                                "Added"
                            ) : (
                ...
                <div className="hidden md:block w-1/4">                        
                    <button 
                        onClick={addFoodToCart} 
                        disabled={food.isAddedToCart} 
                        className="flex items-center gap-2 text-zomato-400 bg-zomato-50 border-zomato-400 px-4 py-2 rounded-lg"
                    >
                        {food.isAddedToCart ? (
                            "Added" 
                        ) : (
